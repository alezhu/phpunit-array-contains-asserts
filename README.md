...
> [!NOTE]
> This branch is for **PHPUnit 9**. For other PHPUnit versions, please use the corresponding branch:
> - For **PHPUnit 10 / 11**: Use the [main branch](https://github.com/alezhu/phpunit-array-contains-asserts/tree/main).
...
- By using the
  static [class
  `Alezhu\PHPUnitArrayContainsAsserts\Assert`](https://github.com/alezhu/phpunit-array-contains-asserts/blob/PHPUnit_9/src/Assert.php)
- By using
  the [trait
  `Alezhu\PHPUnitArrayContainsAsserts\ArrayContainsTrait`](https://github.com/alezhu/phpunit-array-contains-asserts/blob/PHPUnit_9/src/ArrayContainsTrait.php)
  in your test case
- By creating
  new [constraint instances](https://github.com/alezhu/phpunit-array-contains-asserts/tree/PHPUnit_9/src/Constraint) (
...
throw [class
`Alezhu\PHPUnitArrayContainsAsserts\Exception\InvalidArgumentTypeException`](https://github.com/alezhu/phpunit-array-contains-asserts/blob/PHPUnit_9/src/Exception/InvalidArgumentTypeException.php) (
...
The [
`ArrayContains` constraint](https://github.com/alezhu/phpunit-array-contains-asserts/blob/PHPUnit_9/src/Constraint/ArrayContains.php)
...
The [
`ArrayContainsOnly` constraint](https://github.com/alezhu/phpunit-array-contains-asserts/blob/PHPUnit_9/src/Constraint/ArrayContainsOnly.php)
