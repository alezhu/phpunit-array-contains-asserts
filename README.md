...
| :--- | :--- | :--- | :--- | :--- |
| **PHPUnit 13** | [![PHPUnit 13 Tag](https://img.shields.io/github/v/tag/alezhu/phpunit-array-contains-asserts?filter=13.*&label=v13)](https://github.com/alezhu/phpunit-array-contains-asserts/releases/tag/13.0.0) | [![PHPUnit 13 Build Status](https://img.shields.io/github/actions/workflow/status/alezhu/phpunit-array-contains-asserts/main.yml?branch=main&label=Build)](https://github.com/alezhu/phpunit-array-contains-asserts/actions/workflows/main.yml) | [![Coverage Status](https://coveralls.io/repos/github/alezhu/phpunit-array-contains-asserts/badge.svg?branch=main)](https://coveralls.io/github/alezhu/phpunit-array-contains-asserts?branch=main) | ![PHP >= 8.4](https://img.shields.io/badge/PHP-%3E%3D%208.4-8892BF) |
